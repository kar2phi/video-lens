#!/usr/bin/env python3
"""
Template dev server for video-lens.
Edit template.html, run this script, and see the result through the production renderer.
...
#
# Plain-text fields (VIDEO_TITLE, META_LINE, SUMMARY, TAKEAWAY) use raw Unicode
# for em dashes and smart quotes — the production renderer html-escapes them
# verbatim, so anything written here lands in the page as-is.
# HTML-bearing fields (KEY_POINTS, OUTLINE, DESCRIPTION_SECTION) may use HTML
# entities; the sanitiser preserves them.
...
CONTENT = {
    ...
    "SUMMARY": (
        "Werner Vogels uses his final AWS re:Invent keynote — after 14 consecutive years — "
        "to argue that today's AI moment is not the end of developers but the start of a new "
        "Renaissance, one that will transform the role rather than eliminate it. He introduces the "
        "“Renaissance Developer” framework: five qualities — curiosity, systems "
        "thinking, communication with precision, ownership, and polymathism — that distinguish "
        "builders who will thrive in an AI-driven world. His most concrete warning is the concept of "
        "“verification debt”: AI generates code faster than humans can understand it, "
...
""",
    ...
    "OUTLINE": """
<li><a class="ts" data-t="0" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=0" target="_blank" rel="noopener noreferrer">&#9654; 0:00:00</a> &mdash; <span class="outline-title">Opening Cinematic</span><span class="outline-detail">A short film traces recurring &ldquo;end of the developer&rdquo; fears across technology eras &mdash; punch cards, COBOL, cloud &mdash; framing the keynote&rsquo;s central question.</span></li>
<li><a class="ts" data-t="314" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=314" target="_blank" rel="noopener noreferrer">&#9654; 0:05:14</a> &mdash; <span class="outline-title">Werner&rsquo;s Farewell &amp; Central Question</span><span class="outline-detail">Werner announces this is his final re:Invent keynote after 14 years, then addresses the question every customer asks: &ldquo;Will AI make me obsolete?&rdquo;</span></li>
<li><a class="ts" data-t="573" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=573" target="_blank" rel="noopener noreferrer">&#9654; 0:09:33</a> &mdash; <span class="outline-title">History of Developer Evolution</span><span class="outline-detail">From assembly and COBOL to compilers, OOP, microservices, and cloud &mdash; each wave automated tasks and required new skills, and developers adapted every time.</span></li>
<li><a class="ts" data-t="876" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=876" target="_blank" rel="noopener noreferrer">&#9654; 0:14:36</a> &mdash; <span class="outline-title">A New Renaissance</span><span class="outline-detail">Vogels argues that today&rsquo;s convergence of AI, robotics, and space travel mirrors the 15th-century Renaissance, where curiosity, new tools, and cross-disciplinary thinking exploded simultaneously.</span></li>
<li><a class="ts" data-t="1189" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=1189" target="_blank" rel="noopener noreferrer">&#9654; 0:19:49</a> &mdash; <span class="outline-title">Quality 1: Be Curious</span><span class="outline-detail">Curiosity drives learning; the Yerkes-Dodson Law locates peak learning on the rising slope between disengagement and overwhelm, where curiosity meets real challenge.</span></li>
<li><a class="ts" data-t="1510" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=1510" target="_blank" rel="noopener noreferrer">&#9654; 0:25:10</a> &mdash; <span class="outline-title">Learning from the Field: Africa &amp; Latin America</span><span class="outline-detail">Real-world examples from Vogels&rsquo; travels &mdash; Ocean Cleanup&rsquo;s AI river model, Rwanda&rsquo;s health intelligence center, and KOKO Networks&rsquo; ethanol ATMs in Nairobi &mdash; show developers solving humanity&rsquo;s hardest problems.</span></li>
<li><a class="ts" data-t="2000" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=2000" target="_blank" rel="noopener noreferrer">&#9654; 0:33:20</a> &mdash; <span class="outline-title">Quality 2: Think in Systems</span><span class="outline-detail">Donella Meadows&rsquo; systems theory and the Yellowstone wolf trophic cascade illustrate how a single feedback loop can reshape an entire system &mdash; a lesson directly applicable to software architecture.</span></li>
<li><a class="ts" data-t="2284" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=2284" target="_blank" rel="noopener noreferrer">&#9654; 0:38:04</a> &mdash; <span class="outline-title">Quality 3: Communicate with Precision</span><span class="outline-detail">Natural language is ambiguous; specifications reduce that ambiguity, both when communicating with AI tools and when aligning engineering decisions with business stakeholders.</span></li>
<li><a class="ts" data-t="2574" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=2574" target="_blank" rel="noopener noreferrer">&#9654; 0:42:54</a> &mdash; <span class="outline-title">Kiro IDE: Spec-Driven Development Demo</span><span class="outline-detail">Clare Liguori walks through how the Kiro IDE was built using spec-driven development &mdash; requirements, design, and tasks generated and refined before any code is written &mdash; cutting development time by ~50%.</span></li>
<li><a class="ts" data-t="3219" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=3219" target="_blank" rel="noopener noreferrer">&#9654; 0:53:39</a> &mdash; <span class="outline-title">Quality 4: Be an Owner</span><span class="outline-detail">Vogels introduces &ldquo;verification debt&rdquo; and &ldquo;hallucination&rdquo; as the two main challenges of AI coding, arguing that vibe coding without ownership is gambling &mdash; regulatory and quality responsibility remains yours.</span></li>
<li><a class="ts" data-t="3595" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=3595" target="_blank" rel="noopener noreferrer">&#9654; 0:59:55</a> &mdash; <span class="outline-title">Mechanisms vs. Good Intentions</span><span class="outline-detail">The Amazon Andon Cord story and S3&rsquo;s durability reviews demonstrate that mechanisms &mdash; not intentions &mdash; convert quality goals into consistent outcomes; code reviews matter more in an AI-driven world, not less.</span></li>
<li><a class="ts" data-t="3916" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=3916" target="_blank" rel="noopener noreferrer">&#9654; 1:05:16</a> &mdash; <span class="outline-title">Quality 5: Become a Polymath</span><span class="outline-detail">Jim Gray&rsquo;s T-shaped expertise &mdash; deep database mastery plus broad curiosity &mdash; enabled breakthrough work in astronomy; Vogels urges developers to &ldquo;broaden their T&rdquo; beyond single-domain depth.</span></li>
<li><a class="ts" data-t="4279" href="https://www.youtube.com/watch?v=3Y1G9najGiI&t=4279" target="_blank" rel="noopener noreferrer">&#9654; 1:11:19</a> &mdash; <span class="outline-title">Summary &amp; Closing: Professional Pride</span><span class="outline-detail">The five Renaissance Developer qualities are recapped, and Vogels closes with a call to take pride in the invisible craft of building reliable systems &mdash; the clean deployments and overnight uptime that no customer will ever see.</span></li>
""",

    "TAKEAWAY": (
        "The practical consequence of AI-assisted development that most developers underestimate is "
        "“verification debt”: when the machine writes the code, comprehension must be "
        "rebuilt during review, and that gap — between generation speed and comprehension speed "
        "— is where unvalidated software reaches production. Spec-driven development, as "
        "demonstrated with the Kiro IDE (requirements → design → tasks, all refined before "
        "any code is written), is the most concrete mechanism to close this gap: it front-loads "
        "disambiguation, catches AI hallucinations at the design stage, and in the Kiro team's "
    ...
    "DESCRIPTION_SECTION": (
        ...
        '<a href="https://go.aws/events" target="_blank" rel="noopener noreferrer">https://go.aws/events</a><br>'
        " <br>"
        "Subscribe: <br>"
        'More AWS videos: <a href="http://bit.ly/2O3zS75" target="_blank" rel="noopener noreferrer">http://bit.ly/2O3zS75</a> <br>'
        'More AWS events videos: <a href="http://bit.ly/316g9t4" target="_blank" rel="noopener noreferrer">http://bit.ly/316g9t4</a><br><br>'
        "ABOUT AWS<br>"
